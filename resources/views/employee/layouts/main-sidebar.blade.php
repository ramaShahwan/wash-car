			...
			<div class="main-sidemenu">
				...
				<ul class="side-menu">
					...
					<li class="slide">
						...
						<ul class="slide-menu">
							<li><a class="slide-item" href="{{ url('/get_orders') }}">الطلبات التي يجب إنجازها</a></li>
							<li><a class="slide-item" href="{{ url('/acceptedFromEmp') }}">الطلبات قيد انتظار الإنجاز</a></li>
					...
					<li class="slide">
						...
						<ul class="slide-menu">
							<li><a class="slide-item" href="">جميع الصور </a></li>
