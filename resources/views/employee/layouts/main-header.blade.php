				...
				<div class="container-fluid">
					<div class="main-header-left ">
						<div class="responsive-logo">
							<a href="{{ url('/' . $page='index') }}"><img src="{{ asset('site/img/icon/icon.webp') }}" class="logo-1" alt="logo"></a>
							<a href="{{ url('/' . $page='index') }}"><img src="{{ asset('site/img/icon/icon.webp') }}" class="dark-logo-1" alt="logo"></a>
							<a href="{{ url('/' . $page='index') }}"><img src="{{ asset('site/img/icon/icon.webp') }}" class="logo-2" alt="logo"></a>
							<a href="{{ url('/' . $page='index') }}"><img src="{{ asset('site/img/icon/icon.webp') }}" class="dark-logo-2" alt="logo"></a>
						</div>
