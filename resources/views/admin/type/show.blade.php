						...
						<div class="card">
							<div class="card-header pb-0">
								<div class="d-flex justify-content-between">
									<h4 class="card-title mg-b-0">جميع أنواع السيارات</h4>
									...
									<table class="table text-md-nowrap" id="example1">
										...
										<tbody>
											...
											<tr>
												...
												<td>
													<a class="btn btn-sm btn-info" href="{{ route('type.edit', $type->id) }}" title="تعديل"><i class="las la-pen"></i></a>
												</td>
												<td>
													<a class="modal-effect btn btn-sm btn-danger" data-toggle="modal" style="cursor: pointer;"
													data-target="#delete{{$type->id}}"><i class="las la-trash"></i></a>
													<form action="{{route('type.delete', $type->id)}}" method="POST" enctype="multipart/form-data">
															@csrf
															@method('DELETE')
														<div id="delete{{$type->id}}" class="modal fade delete-modal" role="dialog">
															<div class="modal-dialog modal-dialog-centered">
																<div class="modal-content">
			
																	<div class="modal-header">
																		<h6 class="modal-title">حذف نوع السيارة: &nbsp; {{$type->name}}</h6><button aria-label="Close" class="close" data-dismiss="modal"
