			...
			<div class="main-sidemenu">
				...
				<ul class="side-menu">
					...
					<li class="slide">
						...
						<ul class="slide-menu">
							<li><a class="slide-item" href="{{ url('') }}">الطلبات المعلقة</a></li>
							<li><a class="slide-item" href="{{ url('') }}">الطلبات قيد الإنجاز</a></li>
							<li><a class="slide-item" href="{{ url('') }}">الطلبات المنجزة</a></li>
							<li><a class="slide-item" href="{{ url('') }}">الطلبات المرفوضة</a></li>
						</ul>
					</li>
