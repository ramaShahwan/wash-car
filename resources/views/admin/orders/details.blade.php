                                ...
                                {{-- @foreach ($order as $ord) --}}
									...
									<div class="row">
										<div class="col">
											...
											id="inputName" name="sizeOfCar" value="{{ $order->sizeOfCar }}" required>
										</div>
									</div><br>
									...
									<div class="row">
										<div class="col">
											...
											<input type="hidden" name="name" value="{{ $primary }}">
											<input type="text" class="form-control "
											id="inputName" name="name" value="{{ $primary}}" required>
										</div>
									</div><br>



									@if(isset($sec) && !$sec->isEmpty()) 
									...
									<div class="row">
										<div class="col">
											...
											<input type="text" class="form-control "
											id="inputName" name="name" value="{{ $ser }}" required>
										</div>
									</div><br>
									...
									<div class="row">
										<div class="col">
											...
											<input type="hidden" name="sizeOfCar" value="{{ $ord->sizeOfCar }}">
											<input type="text" class="form-control "
											id="inputName" name="sizeOfCar" value="{{ $ord->sizeOfCar }}" required>
										</div>
									</div><br>
