							...
							<div class="card-body">
								...
								<div class="row">
									...
									{{-- <div class="col-6">
										...
										<input type="hidden" name="employee_id" value="{{ App\Models\Employee::findOrFail($home->employee_id)->firstName }} {{ App\Models\Employee::findOrFail($home->employee_id)->lastName }}">
										<input type="text" class="form-control"
										id="inputName" name="employee_id" value="{{ App\Models\Employee::findOrFail($home->employee_id)->firstName }} {{ App\Models\Employee::findOrFail($home->employee_id)->lastName }}" readonly>
									</div> --}}

									<div class="col-6">
										<label for="inputName" class="control-label"> اسم الموظف</label>
										@php
											$employee = App\Models\Employee::find($home->employee_id);
										@endphp
										<input type="hidden" name="name" value="{{ $employee ? $employee->firstName . ' ' . $employee->lastName : '' }}">
										<input type="text" class="form-control" id="inputName" name="name" value="{{ $employee ? $employee->firstName . ' ' . $employee->lastName : '' }}" readonly>
									</div>
								...
								<div class="row">
									...
									<div class="row">
										...
										<div class="col-6">
											...
											<input type="text" class="form-control" id="inputName" name="cleanMaterial" value="{{ $home->cleanMaterial == 1 ? 'نعم' : 'لا' }}" readonly>
										</div>
									</div><br>
