						...
						<div class="card">
							<div class="card-header pb-0">
								<div class="d-flex justify-content-between">
									<h4 class="card-title mg-b-0">الطلبات المنجزة (غسيل سيارات)</h4>
								...
								<div class="row row-sm">
									<div class="col-xl-12">
										<div class="card">
											<div class="card-header pb-0">
												<div class="d-flex justify-content-between">
													<h4 class="card-title mg-b-0">الطلبات المنجزة (تنظيف منزلي)</h4>
													<i class="mdi mdi-dots-horizontal text-gray"></i>
												</div>
											</div>
													...
													<table class="table text-md-nowrap" id="example1">
														...
														<tbody>
															...
															<tr>
																...
																<td>
																	<form action="{{ route('ord.details_home', $home->id) }}" method="get" enctype="multipart/form-data" autocomplete="off">
																		@csrf
																		@method('GET')
																		<button class="btn btn-sm btn-info" title="تفاصيل"><i class="la la-archive"></i></button>
																	</form>
